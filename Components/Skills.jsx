        ...
        >
          <div className="flex justify-start items-center gap-2 lg:gap-4">
            ...
            className="w-40 lg:w-56 h-4 lg:h-6 bg-slate-700 dark:bg-white rounded-3xl">
              <span
               className="block  w-36  lg:w-[200px]  h-4 lg:h-6  bg-gradient-to-r from-yellow-500 via-purple-400 to-red-500 dark:bg-slate-700 dark:text-white"></span>
            </div>
          </div>
          ...
          <div className="flex justify-start items-center gap-2 ">
            ...
            <div className="w-40 lg:w-56 h-4 lg:h-6 bg-slate-700 dark:bg-white rounded-3xl">
              ...
              bg-gradient-to-r from-yellow-500 via-purple-400 to-red-500 dark:bg-slate-700 dark:text-white"></span>
            </div>
          </div>
